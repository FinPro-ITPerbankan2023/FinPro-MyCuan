@section('title', 'Register Pemberi Dana')
        ...
        <div class="w-1/2 bg-[#13A89E] max-h-full">
            <div class="flex flex-col w-3/4 h-3/4 mx-auto mt-2 content-center">
                <div class="w-8/12 mx-auto text-center">
                    <h1 class="text-white mt-16 font-bold font-poppins text-3xl">Registrasi</h1>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="w-8/12 mt-6 mx-auto">
                        ...
                        <div
                            class="flex flex-row items-center w-full bg-white rounded-md hover:border-indigo-500 border-transparent border-2 mt-2">
                            <x-input id="phone_number" type="number" placeholder="{{ __('Masukan nomor telepon') }} " name="phone_number" :value="old('phone_number')" required
                    ...
                    <div class="w-8/12 mt-6 mx-auto">
                        <x-input-label class="text-white text-xl font-poppins dark:text-white" for="identity_number"
                                       value="{{ __('Nomor KTP')}}" />
                        <div
                            class="flex flex-row items-center w-full bg-white rounded-md hover:border-indigo-500 border-transparent border-2 mt-2">
                            <x-input id="identity_number" type="number" placeholder="{{ __('Masukan nomor telepon') }} " name="identity_number" :value="old('identity_number')" required
                                     class="w-full py-2.5 ml-3 px-0 border-transparent focus:border-transparent focus:ring-0 dark:bg-white dark:border-transparent dark:focus:ring-0 dark:focus:border-transparent" :value="old('identity_number')" required />
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col w-8/12 mt-6 mx-auto text-white font-poppins">
                        ...
                        <ul class="list-disc ml-8 font-semibold text-lg mt-2">
                            <li>
                                <a class="underline" href="{{ route('terms.show') }}" target="_blank">Syarat & Ketentuan</a>
                            </li>
                            <li>
                                <a class="underline" href="{{ route('policy.show') }}" target="_blank">Kebijakan Privasi</a>
                            </li>
                        </ul>
                    ...
                    <p class="w-8/12 mt-6 mx-auto justify-center text-lg">Sudah punya akun? <a href="/login" class="underline">login disini</a></p>
